...
app.get('/todos', function(req,res,next) {
  ...
  con.query(sql, [req.session.id], function(err, results) {
    if (err) {
      throw err;
    }
...
app.post('/todo', function(req,res,next) {
  ...
  con.query(sql, [req.body.todo, req.session.id], function(err, results) {
    if (err) {
      throw err;
    }
...
app.put('/todo/:id', function(req,res,next) {
  ...
  con.query(sql, [req.body.completed, req.params.id], function(err, results) {
    if (err) {
      throw err;
    }
    res.end();
